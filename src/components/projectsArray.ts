...
export const projectsObj: ProjectObject[] = [
  {
    ...
    p: 'Displays stats and info for the game Apex Legends. Users can access up-to-date game info and player stats. Uses React, Tailwind, daisyUI, Axios, Context, and Reducer.',
  ...
  },
  {
    ...
    title: 'To-do Website',
    p: 'A simple To-do project. Uses MERN Stack, Material UI, Axios, Redux.',
  ...
  },
  {
    ...
    p: 'A simple blog website made with Next.js and Strapi. Followed Bulletproof React coding principles. Custom design without any framework. Uses Next.js, Strapi, Axios, Sass, Typescript, SWR, Markdown-it, next-seo, and Cloudinary.',
